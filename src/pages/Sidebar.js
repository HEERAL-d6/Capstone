                    ...
                    <li
                        ...
                        {number == 1 ?
                            <a
                                ...
                                <HomeIcon /> <strong class="pt-5 px-2"><Link  style={{ textDecoration: "none", color: "black" }} to='/'>Home</Link></strong>
                            ...
                            <a
                                ...
                                aria-current="page"
                            >
                                <HomeIcon /> <lead class="pt-5 px-2"><Link onClick={() => setNumber(1)} style={{ textDecoration: "none", color: "black" }} to='/'> Home</Link></lead>
